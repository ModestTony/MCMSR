...
class RefRestorationModel(SRModel):
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        cnt = 0;k1 = 0.05;k2 = 0.38;k3 = 0.27;k4 = 0.38;k11 = 0.01;k21 = 0.004
        for idx, val_data in enumerate(dataloader):
            ...
            psnr = metrics.psnr(sr_img, gt_img, crop_border=self.opt['crop_border'])
            avg_psnr += psnr
        ...
        logger.info(
            f'# Validation {dataset_name} # PSNR: {avg_psnr:.4e} 'f'# PSNR_Y: {avg_psnr_y:.4e} # SSIM_Y: {avg_ssim_y:.4e}.')
        if tb_logger:
