...
class DynamicAggregationRestoration(nn.Module):
    ...
    def forward(self, x, pre_offset, img_ref_feat , max_val):
        ...
        for i in range(topk):
            ...
            relu3_swapped_feat = self.lrelu(self.small_dyn_agg([img_ref_feat['relu3_1'], relu3_offset], pre_offset_relu3_1[:,i,:,:,:,:]))
            ...
            relu2_swapped_feat = self.lrelu(self.medium_dyn_agg([img_ref_feat['relu2_1'], relu2_offset], pre_offset_relu2_1[:,i,:,:,:,:]))
            ...
            relu1_swapped_feat = self.lrelu(self.large_dyn_agg([img_ref_feat['relu1_1'], relu1_offset], pre_offset_relu1_1[:,i,:,:,:,:]))
